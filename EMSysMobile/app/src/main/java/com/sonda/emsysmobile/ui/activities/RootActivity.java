...
//        getSupportActionBar().set(true);//setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setTitle("Detalle de evento");

        final IProfile profile = new ProfileDrawerItem().withName("Mike Penz").withEmail("mikepenz@gmail.com").withIcon("https://avatars3.githubusercontent.com/u/887462?v=3&s=460");
